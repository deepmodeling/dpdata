...
2 1 2 1.2621856 0.7018028 0.5513885"""
    ...
    def test_full_style_parsing(self):
        ...
        system = dpdata.System(self.test_files['full'], fmt="lammps/lmp", 
                              type_map=["O", "H"], atom_style="full")
    ...
    def test_charge_style_parsing(self):
        ...
        system = dpdata.System(self.test_files['charge'], fmt="lammps/lmp", 
                              type_map=["O", "H"], atom_style="charge")
    ...
    def test_bond_style_parsing(self):
        ...
        system = dpdata.System(self.test_files['bond'], fmt="lammps/lmp", 
                              type_map=["O", "H"], atom_style="bond")
    ...
    def test_unsupported_atom_style(self):
        ...
        with self.assertRaises(ValueError) as context:
            dpdata.System(self.test_files['bond'], fmt="lammps/lmp", 
                         type_map=["O", "H"], atom_style="unsupported_style")
    ...
    def test_default_atomic_style(self):
        ...
        system1 = dpdata.System(os.path.join("poscars", "conf.lmp"), type_map=["O", "H"])
        system2 = dpdata.System(os.path.join("poscars", "conf.lmp"), type_map=["O", "H"], atom_style="atomic")
