...
def _to_system_data_lower(lines, lines_incar, cartesian=True):
...
def to_system_data(lines, lines_incar):
    ...
    return _to_system_data_lower(lines, lines_incar, is_cartesian)
